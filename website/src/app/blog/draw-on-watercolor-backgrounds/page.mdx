...
<PinterestImage
  src="/designs/whispers-of-bloom.png"
  alt="Watercolor background with soft floral forms — ready for ink outlines"
  title="How to Draw on Watercolor Backgrounds"
  description="The right pens, techniques for finding form in color, and composition tips for adding ink to any watercolor background. Free designs at FreeReverseColoring.com"
/>
